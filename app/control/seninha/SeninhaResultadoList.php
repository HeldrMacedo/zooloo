...
class SeninhaResultadoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_search_seninha_resultado');
        $this->form->setFormTitle('Seninha — Resultado dos Sorteios');
        ...
        $action_edit = new TDataGridAction(['SeninhaResultadoForm', 'onEdit'], ['key' => '{sorteio_id}']);
