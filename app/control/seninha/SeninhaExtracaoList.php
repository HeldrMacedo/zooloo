...
class SeninhaExtracaoList extends TPage
{
    protected $form;
    protected $datagrid;
    ...
    public function __construct()
    {
        ...
        $action_edit = new TDataGridAction(['SeninhaExtracaoForm', 'onEdit'], ['key' => '{extracao_id}', 'register_state' => 'false']);
    ...
    public function onReload($param = null)
    {
        try
        {
            ...
            $criteria->add(new TFilter('filtro_banca', '=', 3));
