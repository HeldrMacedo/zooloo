...
class SeninhaExtracaoForm extends TPage
{
    protected $form;
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_seninha_extracao_form');
        $this->form->setFormTitle('Seninha — Editar Extração');
    ...
    public function onSave($param = null)
    {
        try
        {
            ...
            $pos_action = new TAction(['SeninhaExtracaoList', 'onReload']);
