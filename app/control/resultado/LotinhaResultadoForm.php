...
class LotinhaResultadoForm extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Resultado da Lotinha');
        ...
        $numeros_sorteados->placeholder = '00,00,00,00,00,00,00,00,00,00,00,00,00,00,00';
        ...
        $this->form->addContent(['<hr>']);
        $this->form->addFields([new TLabel('Números Sorteados (15 dezenas):')], [$numeros_sorteados]);
