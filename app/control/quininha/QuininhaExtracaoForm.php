...
class QuininhaExtracaoForm extends TPage
{
    protected $form;
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_quininha_extracao_form');
        $this->form->setFormTitle('Quininha — Editar Extração');
    ...
    public function onSave($param = null)
    {
        try
        {
            ...
            $pos_action = new TAction(['QuininhaExtracaoList', 'onReload']);
