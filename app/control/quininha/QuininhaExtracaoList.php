...
class QuininhaExtracaoList extends TPage
{
    protected $form;
    protected $datagrid;
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_quininha_extracao');
        $this->form->setFormTitle('Quininha — Extrações');
        ...
        $action_edit = new TDataGridAction(['QuininhaExtracaoForm', 'onEdit'], ['key' => '{extracao_id}', 'register_state' => 'false']);
    ...
    public function onReload($param = null)
    {
        try
        {
            ...
            $criteria->add(new TFilter('filtro_banca', '=', 2));
