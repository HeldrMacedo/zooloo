...
class QuininhaModalidadeList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_quininha_modalidade');
        ...
        $col_quina   = new TDataGridColumn('multiplicador_colocacao_01', 'Prêmio Quina (5 ac.)', 'right', '16%');
        $col_quadra  = new TDataGridColumn('multiplicador_colocacao_02', 'Prêmio Quadra (4 ac.)', 'right', '16%');
        $col_terno   = new TDataGridColumn('multiplicador_colocacao_03', 'Prêmio Terno (3 ac.)', 'right', '16%');
