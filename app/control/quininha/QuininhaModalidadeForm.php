...
class QuininhaModalidadeForm extends TPage
{
    protected $form;
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_quininha_modalidade_edit');
        $this->form->setFormTitle('Quininha — Editar Modalidade');
        ...
        $mult_colocacao_01->addValidation('Prêmio Quina', new TRequiredValidator);
        $mult_colocacao_02->addValidation('Prêmio Quadra', new TRequiredValidator);
        $mult_colocacao_03->addValidation('Prêmio Terno', new TRequiredValidator);
        ...
        $this->form->addFields(
            [new TLabel('Prêmio Terno (3 ac.) <span class="text-danger">*</span>')],
            [$mult_colocacao_03]
        );
    ...
    public function onSave($param = null)
    {
        try {
            ...
            $pos_action = new TAction(['QuininhaModalidadeList', 'onReload']);
