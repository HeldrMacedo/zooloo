...
class LotinhaModalidadeForm extends TPage
{
    protected $form;
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_lotinha_modalidade_edit');
        $this->form->setFormTitle('Lotinha — Editar Modalidade');
        ...
        $mult_colocacao_01->addValidation('Cotação', new TRequiredValidator);
        ...
        $this->form->addFields(
            [new TLabel('Cotação <span class="text-danger">*</span>')],
            [$mult_colocacao_01]
        );
    ...
    public function onSave($param = null)
    {
        try {
            ...
            $pos_action = new TAction(['LotinhaModalidadeList', 'onReload']);
