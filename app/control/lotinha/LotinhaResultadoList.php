...
class LotinhaResultadoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_search_lotinha_resultado');
        $this->form->setFormTitle('Lotinha — Resultado dos Sorteios');
        ...
        $col_id       = new TDataGridColumn('sorteio_id',        'ID',                'center', '6%');
        $col_extracao = new TDataGridColumn('descricao',         'Extração',          'left',   '18%');
        $col_data     = new TDataGridColumn('data_sorteio',      'Data Sorteio',      'center', '10%');
        $col_hora     = new TDataGridColumn('hora_sorteio',      'Hora Sorteio',      'center', '10%');
        $col_situacao = new TDataGridColumn('situacao',          'Situação',          'center', '10%');
        $col_numeros  = new TDataGridColumn('numeros_sorteados', 'Números Sorteados', 'left',   '36%');
        ...
        $action_edit = new TDataGridAction(['LotinhaResultadoForm', 'onEdit'], ['key' => '{sorteio_id}']);
