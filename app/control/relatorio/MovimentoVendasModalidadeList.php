...
class MovimentoVendasModalidadeList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $col_modal    = new TDataGridColumn('modalidade', 'Modalidade', 'left', '22%');
        $col_qtde     = new TDataGridColumn('qtde', 'Qtde', 'center', '10%');
        $col_apurado  = new TDataGridColumn('apurado', 'Apurado', 'right', '16%');
        $col_comissao = new TDataGridColumn('comissao', 'Comissão', 'right', '16%');
        $col_liquido  = new TDataGridColumn('liquido', 'Líquido', 'right', '16%');
        $col_premio   = new TDataGridColumn('premio', 'Prêmio', 'right', '16%');
        ...
        foreach ([$col_modal,$col_qtde,$col_apurado,$col_comissao,$col_liquido,$col_premio] as $c) {
